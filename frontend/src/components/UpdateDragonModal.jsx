...
const UpdateDragonModal = ({ dragon, onClose, onUpdated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const updatedDragon = await apiClient.updateDragon(dragon.id, dragonData);
      onUpdated(updatedDragon);
      onClose();
    } catch (error) {
      console.error('Failed to update dragon:', error);
      setErrors({ submit: 'Failed to update dragon' });
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="modal-overlay">
      <div className="modal-content">
        <div className="modal-header">
          <h2 className="modal-title">Update Dragon</h2>
        </div>
...
export default UpdateDragonModal;